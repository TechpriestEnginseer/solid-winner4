...
public class eis_irsmommies implements BaseCommand {
    ...
    public CommandResult runCommand(String args, CommandContext context) {
        ...
        if (Global.getSector().getEconomy().getMarket("chitagupta") != null || Global.getSector().getEconomy().getMarket("yami") != null) {
                Console.showMessage("Error: Have, very cheeky of you.");
                return CommandResult.ERROR;
        }
        if (Global.getSector().getStarSystem("Naraka") != null) {
            ...
            PlanetAPI naraka_b = system.addPlanet("yami", Global.getSector().getEntityById("yama"), "Yami", "cryovolcanic", 0, 60, 650, 40); //formerly 450
        ...
        Console.showMessage("Chitagupta and Yami creating.... done! If you did something to these two planets, WELP THAT'S ON YOU!");
