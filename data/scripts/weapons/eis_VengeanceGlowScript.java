...
public class eis_VengeanceGlowScript implements EveryFrameWeaponEffectPlugin {
    ...
    private static float EFFECT_RANGE = 380f; //Should be 400f, but for "player visual purposes" we reduce it by 5% See some random player theory crap.
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (ship.getSystem().isActive() || !player || ship.isHulk() || ship.isPiece() || !ship.isAlive()) {
