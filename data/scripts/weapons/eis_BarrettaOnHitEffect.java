...
public class eis_BarrettaOnHitEffect implements OnHitEffectPlugin {

	public static float DAMAGE = 250f;
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target,
		...
		if (!shieldHit && target instanceof ShipAPI) {
			...
			engine.spawnExplosion(projectile.getLocation(), target.getVelocity(), new Color(255,120,190,20), 120f, 0.2f);
		}
