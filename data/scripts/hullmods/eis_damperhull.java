...
public class eis_damperhull extends BaseHullMod {
    ...
    private static String vanagloriaStatusTextUI4 = Global.getSettings().getString("eis_ironshell", "eis_vanagloriaStatusTextUI14");
    ...
    private float eis_damperhull3(ShipAPI ship) {
        if (ship.getShield() != null) {
            ...
            return cooldown/((ship.getPhaseCloak().getFluxPerSecond()+ship.getPhaseCloak().getFluxPerUse())*6f/ship.getHullSpec().getFluxCapacity()); //ship.getMaxFlux(), this gets total things!
        } else {
