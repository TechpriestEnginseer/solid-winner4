...
public class eis_zandatsu extends BaseHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        parry.addPara(ParryText1, 0f, YELLOW, Integer.toString(Math.round(PARRY_RADIUS)));
        ...
        parry.addPara(ParryText3, 0f, Misc.getPositiveHighlightColor(), Math.round(PARRY_ROF_BUFF)+"%", Integer.toString(Math.round(PARRY_BUFF_DURATION)));
        parry.addPara(ParryText4, 0f, Misc.getPositiveHighlightColor(), Math.round(PARRY_FLUX_BUFF)+"%", Integer.toString(Math.round(PARRY_BUFF_DURATION)));
        tooltip.addImageWithText(PAD);        
