...
public class eis_indomitable extends BaseHullMod {
    ...
    public static String pogIcon = "graphics/icons/hullsys/burn_drive.png";
    ...
    public static String indeezTitle2 = Global.getSettings().getString("eis_ironshell", "eis_indeezTitle2");
    public static String indeezText1a = Global.getSettings().getString("eis_ironshell", "eis_indeezText1a");
    private static final float REDUCTION_PERCENT = 40f;
    private static final float REDUCTION_PERCENT2 = 50f;
