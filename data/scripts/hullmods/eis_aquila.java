...
public class eis_aquila extends BaseHullMod {
    ...
    public void applyEffectsAfterShipCreation(ShipAPI ship, String id) {
        ...
        if (ship.getOwner() == 0) {
            ...
            /*if (stats.getBallisticWeaponRangeBonus().getFlatBonus() > 0 || stats.getBallisticWeaponRangeBonus().getBonusMult() > 1 || 
                    stats.getBeamPDWeaponRangeBonus().getFlatBonus() > 0 || stats.getBeamPDWeaponRangeBonus().getBonusMult() > 1 ||
                    stats.getBeamWeaponRangeBonus().getFlatBonus() > 0 || stats.getBeamWeaponRangeBonus().getBonusMult() > 1 ||
                    stats.getEnergyWeaponRangeBonus().getFlatBonus() > 0 || stats.getEnergyWeaponRangeBonus().getBonusMult() > 1 ||
                    stats.getNonBeamPDWeaponRangeBonus().getFlatBonus() > 0 || stats.getNonBeamPDWeaponRangeBonus().getBonusMult() > 1) {
                getreal = true;
            }*/
    ...
    public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {  
        if (stats.getMaxSpeed().base >= (Float) speedcheck.get(hullSize)) {
            ...
            stats.getDeceleration().modifyFlat(id, (Float) speed.get(hullSize) * 1.6f);
        } else {
            ...
            stats.getDeceleration().modifyFlat(id, (Float) stats.getDeceleration().base * 1.2f);
        };
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        if (getreal) {
            tooltip.addPara((aquilaText5b).toUpperCase(), 10f, Misc.getNegativeHighlightColor(), aquilaText5.toUpperCase());
        } else {tooltip.addPara(aquilaText5, 10f, Misc.getNegativeHighlightColor(), aquilaText5);}
