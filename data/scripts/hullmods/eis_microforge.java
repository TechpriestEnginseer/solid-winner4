...
public class eis_microforge extends BaseHullMod {
    ...
    static {
        missiletimer.put(HullSize.FRIGATE, 60f);
        missiletimer.put(HullSize.DESTROYER, 60f);
        missiletimer.put(HullSize.CRUISER, 60f);
        missiletimer.put(HullSize.CAPITAL_SHIP, 45f);
    }
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        rapidAmmoFeeder.addPara(mfText, 0f, Misc.getPositiveHighlightColor(), Integer.toString(Math.round((Float) missiletimer.get(hullSize))), Integer.toString(Math.round(FLAT_RELOAD)), Math.round(TIME_PER_RELOAD)+"%");
