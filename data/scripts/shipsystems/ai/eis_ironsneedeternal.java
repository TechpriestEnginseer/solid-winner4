...
public class eis_ironsneedeternal implements ShipSystemAIScript {
    ...
    private final float EFFECT_RANGE = 300f;
    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {
        ...
        if (tracker.intervalElapsed()) {
            ...
            if (system.getAmmo() <= 1) {
                ...
                desire -= 0.1f;
            } else {} // 3 why are you holding onto it? USE IT.
            ...
            if (desire >= 5f || missileThreatLevel >= MathUtils.getRandomNumberInRange(0.3f,1.2f) * ship.getHitpoints() * ((1-ship.getFluxTracker().getFluxLevel()))/2.5 ) {
                ship.useSystem();
                desire = 0f;
            }
        }
