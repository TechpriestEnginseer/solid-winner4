...
public class eis_jump extends BaseShipSystemScript {
    ...
    static {
        ...
        IMGONNACHARGE.put(HullSize.CRUISER, 1);
        IMGONNACHARGE.put(HullSize.CAPITAL_SHIP, 1);
        ...
        OHGODIMRECHARGING.put(HullSize.CRUISER, 0.13f);
        OHGODIMRECHARGING.put(HullSize.CAPITAL_SHIP, 0.13f);
    }
    ...
    public void unapply(MutableShipStatsAPI stats, String id) {
        ...
        ship.setJitter(this, ENGINE_COLOR, 0f, 5, 0f, 13f);
        ship.setJitterUnder(this, ENGINE_COLOR, 0f, 25, 0f, 17f);
    }
