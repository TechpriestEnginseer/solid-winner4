...
public class MyLoveForIron implements EveryFrameScript {
	...
	if (!done) {
        ...
        if (market != null && "ironshell".equals(market.getFactionId()) && market2 != null && "ironshell".equals(market.getFactionId())) {
            ...
            //sweetperson.getStats().setSkillLevel(Skills.WOLFPACK_TACTICS, 1);
            ...
            mommy.getStats().setSkillLevel(Skills.COMBAT_ENDURANCE, 3);
            mommy.getStats().setSkillLevel(Skills.MISSILE_SPECIALIZATION, 3);
            mommy.getStats().setSkillLevel(Skills.TARGET_ANALYSIS, 3);
            mommy.getStats().setSkillLevel(Skills.FIELD_MODULATION, 3);
            mommy.getStats().setSkillLevel(Skills.IMPACT_MITIGATION, 3);
            mommy.getStats().setSkillLevel(Skills.HELMSMANSHIP, 3);
            mommy.getStats().setSkillLevel(Skills.DAMAGE_CONTROL, 3);
            mommy.getStats().setSkillLevel(Skills.POINT_DEFENSE, 3);
            if (Global.getSettings().getSkillSpec("eis_xiv") == null) {throw new RuntimeException("Why is there a skill rework doing a TC?");}
            //Amongus + Sad
            ...
            heartless.getStats().setSkillLevel(Skills.HELMSMANSHIP, 3);
            ...
            heartless.getStats().setSkillLevel(Skills.FIELD_MODULATION, 3);
            heartless.getStats().setSkillLevel(Skills.COMBAT_ENDURANCE, 3);
            heartless.getStats().setSkillLevel(Skills.BALLISTIC_MASTERY, 3);
            ...
            sweetperson.getStats().setSkillLevel(Skills.POLARIZED_ARMOR, 3);
            sweetperson.getStats().setSkillLevel(Skills.HELMSMANSHIP, 3);
            sweetperson.getStats().setSkillLevel(Skills.MISSILE_SPECIALIZATION, 3);
            sweetperson.getStats().setSkillLevel(Skills.FIELD_MODULATION, 3);
            ...
            mommy2.getStats().setSkillLevel(Skills.ORDNANCE_EXPERTISE, 3);
            ...
            coffeemom.getStats().setSkillLevel(Skills.FIELD_MODULATION, 3);
            coffeemom.getStats().setSkillLevel(Skills.SYSTEMS_EXPERTISE, 3);
            coffeemom.getStats().setSkillLevel(Skills.POLARIZED_ARMOR, 3);
