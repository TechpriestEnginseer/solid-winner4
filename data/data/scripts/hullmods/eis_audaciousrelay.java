...
public class eis_audaciousrelay extends BaseHullMod {
    ...
    public static final float poggers = 50f;
    ...
    public static String relayText6 = Global.getSettings().getString("eis_ironshell", "eis_avaritiarelayText6");
    ...
    public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
        if (stats.getVariant().hasHullMod("neural_interface")) {
            stats.getFluxDissipation().modifyFlat(id, 50f);
        }
    }
