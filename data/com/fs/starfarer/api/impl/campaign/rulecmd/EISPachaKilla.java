...
public class EISPachaKilla extends BaseCommandPlugin {
	public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Token> params, Map<String, MemoryAPI> memoryMap) {
            ...
            for (IntelInfoPlugin intel : intels) {
              ...
              if ((colonyIntel.getTarget().getId().equals("market_killa") && colonyIntel.getTarget().getFactionId().equals("ironshell")) || (Global.getSector().getEntityById("killa").getMarket().getFactionId().equals("ironshell")))
                  return true;
            }
            return false;
        }
