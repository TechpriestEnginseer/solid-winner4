...
public class EISCMilitaryCustomBounty extends BaseCustomBounty {
	...
	static {
		...
		//CREATORS.add(new CBRemnantStation()); because this is hardcoded to luddic church, path, and hegemony!
                //CREATORS.add(new EIS_CBRemnantStation());
