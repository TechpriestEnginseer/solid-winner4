...
public class IronShellHQ extends BaseIndustry implements RouteFleetSpawner, FleetEventListener {
	...
	public CampaignFleetAPI spawnFleet(RouteData route) {
		...
		case FAST:
			...
			break;
		case COMBAT:
			combat = Math.round(12f + (float) random.nextFloat() * 5.6f) * 10f; //120-175
		...
		params.modeOverride = Misc.getShipPickMode(market);
                ...
                if (type == PatrolType.COMBAT) {/*params.flagshipVariant = Global.getSettings().getVariant("eis_tyrant_elite");params.flagshipVariantId = "eis_tyrant_elite";params.commander = Global.getSector().getImportantPeople().getPerson("eisdarren");*/} //params.flagshipVariantId = "eis_endeavor_elite";
